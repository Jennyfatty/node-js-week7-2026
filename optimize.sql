...
-- 工單 3：最新購買紀錄牆
CREATE INDEX IF NOT EXISTS idx_credit_purchases_purcahse_at
ON credit_purchases (purchase_at);

-- 工單 4：首頁「進行中課程」
CREATE INDEX IF NOT EXISTS idx_courses_start_end
ON courses (start_at, end_at);
...
CREATE INDEX IF NOT EXISTS idx_course_bookings_cancelled
